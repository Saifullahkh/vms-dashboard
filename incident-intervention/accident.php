...
<div id="dashboard-page">
    ...
    <div id="main-wrapper" class="p-4 p-md-5">
        ...
        <!-- accident -->
          <div id="accident-detail-view" class="">
            <div
            ...
            >
              <div class="d-flex align-items-center">
                <a
                  ...
                  href="./incident-intervention.php"
                  style="
                    width: 40px;
                    height: 40px;
                    display: flex;
            ...
            <div class="bg-white rounded-4 p-4 shadow-sm border">
              <h5 class="fw-bold mb-3">Accident Table</h5>
                ...
                <table class="table table-hover align-middle">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-sm btn-light border" href="./accident-form.php">
    ...
    <div class="modal-body p-4" style="background-color: #f8f9fa">
        <form class="row g-3 px-2">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control border-dark shadow-sm" rows="3">Police FIR registered (#FIR-990). Insurance claim in process. Vehicle towed to workshop.</textarea>
            </div>
