    ...
    <div class="px-4 px-md-5 py-4">
      <div id="dashboard-view" class="fade-in">
        ...
        <div class="row g-4 mb-5">
          ...
          <div class="col-xl-4 col-md-6">
            <a href="./asset-enumeration/asset-enumeration.php" class="text-decoration-none">
              <div class="card metric-card border-0 rounded-5 shadow-hover h-100">
                <div class="card-body p-4 position-relative overflow-hidden">
                  ...
                  <div class="d-flex align-items-center position-relative">
                    ...
                    <div>
                      <h3 class="fw-bolder mb-0 text-dark">850</h3>
                      <p class="text-muted small fw-bold mb-0 opacity-75">Inventory</p>
                    </div>
                    <div class="ms-auto text-end">
                        ...
                        <tbody class="border-top-0">
                            <tr>
                                ...
                                <td class="pe-4 text-end">
                                    <div class="p-2 bg-success-subtle text-success d-inline-block rounded-circle" style="width: 32px; height: 32px; line-height: 16px;">
                            ...
                            <tr>
                                ...
                                <td class="pe-4 text-end">
                                    <div class="p-2 bg-warning-subtle text-warning d-inline-block rounded-circle" style="width: 32px; height: 32px; line-height: 16px;">
