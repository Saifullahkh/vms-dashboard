        ...
        <div id="driver-mate-table-view">
            <div class="d-md-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    <a class="btn secondary-hover rounded-circle me-3" href="./driver-detail.php"
                     style="
                    width: 40px;
                    height: 40px;
                    display: flex;
        ...
        <form class="row g-3 px-2">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                ...
                <input type="text" class="form-control border-dark shadow-sm" value="Flat B-402, North Karachi" />
            </div>
